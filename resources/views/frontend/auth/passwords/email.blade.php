...
@section('content')
    <div class="container">
        ...
        <section class="py-5 bg-light">
            <div class="container">
                <div class="row px-4 px-lg-5 py-lg-4 align-items-center" style="margin-top: 60px;">
                    <div class="col-lg-6">
                        <h1 class="h2 text-uppercase mb-0">Quên mật khẩu</h1>
                    </div>
        ...
        <section class="py-5">
            <h2 class="h5 text-uppercase mb-4">Lấy lại mật khẩu</h2>
            @if (session('success'))
                    ...
                    <div class="table-responsive mb-4">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><b>Địa chỉ email:</b></label>                                
                                <input type="email" class="form-control" required="" name="emailResetPass" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                                <small id="emailHelp" class="form-text text-muted">Vui lòng cung cấp địa chỉ email để lấy lại mật khẩu.</small>
                            </div>
